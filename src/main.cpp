...
// Copyright (c) 2013 Eightcoin Developers
...
uint256 hashGenesisBlock("0x862c65bd4eb8ef0dc6a69d9de7620a360c5e3434c074e3d7fbf1f30fcf771f24");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Eightcoin: starting difficulty is 1 / 2^12
...
static const int64 nTargetTimespan = 60 * 60;	// Eightcoin: 1 hour
static const int64 nTargetSpacing = 88;						// Eightcoin: 30 sec
static const int64 nInterval = nTargetTimespan / nTargetSpacing;
static const int64 nTargetTimespanRe = 60 * 60; // 60 Minutes
static const int64 nTargetSpacingRe = 30; // Eightcoin: 30 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
   ...
   if(fNewDifficultyProtocol) {
    ...
    // Eightcoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal eightcoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x862c65bd4eb8ef0dc6a69d9de7620a360c5e3434c074e3d7fbf1f30fcf771f24");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "eightcoin baidu.com";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x4b661ed1ae7607568d32d95c9d55eb93e1cafa40ba5aa6440b8176e7c1ee9117"));
...
{
	return false;
	//commenting out this code until we properly implement EIC alerts.
	/*
    if (!CheckSignature())
        return false;
    if (!IsInEffect())
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Eightcoin: increase each by adding 2 to bitcoin's value.
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Eightcoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
